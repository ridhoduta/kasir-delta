    ...
    {/* <div className='dashboard'>
      <div className="sidebar-owner">
        ...
        <ul className="menu-items">
         <li className={`menu-item ${isActive('/') || isActive('/beranda-owner') ? 'active' : ''}`}>
            <Link to="/beranda-owner" className="menu-link">
              ...
              <div className="menu-text">Beranda</div>
            </Link>
          </li>
          <li className={`menu-item ${isActive('/pemasukan') ? 'active' : ''}`}>
            <Link to="/pemasukan" className="menu-link">
              ...
              <div className="menu-text">Pemasukan</div>
            </Link>
          </li>
          <li className={`menu-item ${isActive('/pengeluaran') ? 'active' : ''}`}>
            <Link to="/pengeluaran" className="menu-link">
              ...
              <div className="menu-text">Pengeluaran</div>
            </Link>
          </li>
