...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-60 bg-zinc-900 text-white z-50 transform transition-transform duration-300 md:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        {/* Tombol tutup (X) */}
        ...
        <div className="p-4">
          ...
          <ul className="space-y-2">
            <li>
              <Link
                to="/home"
                className={`flex items-center px-4 py-2 rounded transition-all ${isActive('/home') || isActive('/detail-barang') || isActive('/pembayaran') || isActive('/nota') ? 'bg-zinc-800 text-white border-l-4 border-yellow-400'
            ...
            <li>
              <Link
                to="/barang"
                className={`flex items-center px-4 py-2 rounded transition-all ${isActive('/barang') || isActive('/edit-barang')
