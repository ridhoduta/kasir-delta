        ...
        <h2 className="text-xl font-bold mb-4 text-left pl-4 w-full">
          ...
          <ul className="space-y-2">
            <li>
             <Link
              ...
              className={`flex items-center px-4 py-2 rounded transition-all ${
                isActive('/home') || isActive('/detail-barang') || isActive('/pembayaran') || isActive('/nota') ? 'bg-zinc-800 text-white border-l-4 border-yellow-400'
            ...
            <li>
              ...
              to="/barang"
              className={`flex items-center px-4 py-2 rounded transition-all ${
                isActive('/barang') || isActive('/edit-barang')
            ...
            <li>
              ...
              to="/ukuran"
              className={`flex items-center px-4 py-2 rounded transition-all ${
                isActive('/ukuran') || isActive('/edit-ukuran')
                  ? 'bg-zinc-800 text-white border-l-4 border-yellow-400'
                  : 'text-zinc-300 hover:bg-zinc-800'
              }`}
            >
