...
import PemasukanItem from './PemasukanItem';

const PemasukanList = ({ data, handleDelete }) => {
  ...
  return (
    <>
      ...
      <h2 className="text-lg font-semibold mb-4 text-zinc-800">Tabel Pemasukan</h2>
        ...
        <table className="w-full table-auto border border-gray-200 text-sm">
          <thead className="bg-gray-100 text-left text-gray-700">
            <tr>
              ...
              <th className="px-4 py-2 border">Total Pemasukan</th>
